...
'''
index = load_testing_file()
train_data = training_data.T[index[0:392]].T
test_data = test_data.T[index[0:392]].T
...
train_data = sklearn_lda.fit_transform(training_data, training_label)
index = index_list(training_data, train_data)
print (index)

#w = LDA_algorithm(training_data,training_label,392)
